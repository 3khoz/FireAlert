...
leaflet(width = 900, height = 800) %>% 
    ...
    addLegend("bottomleft", colors = c("#FF0000","#12D502","#FFFFFF","#FCEE07","#0F6600","#049BE2","#E204D8","#000000","#0008FF"), labels = c("SIDCO radio: 5 km","SNASPE","SN","BNP","SP","ICP","AAVC","RB","EMN")) %>%
    
    addLayersControl(baseGroups = c("Satélite", "Temático"),
      
    overlayGroups = c("SIDCO","SNASPE","SN","BNP","SP","ICP","AAVC","RB","Ruil","Pitao","Keule","Alerce","Araucaria","Belloto del sur","Belloto del norte"),
                   options = layersControlOptions(collapsed = FALSE))%>%
    hideGroup(c("Límite Regional","SNASPE","SN","BNP","SP","ICP","AAVC","RB","Ruil","Pitao","Keule","Alerce","Araucaria","Belloto del sur","Belloto del norte")) %>%
