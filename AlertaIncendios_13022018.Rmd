...
trb<-iconv.data.frame(as.data.frame(as.character(myRB@data[,3])),from="UTF8",to="latin1")
...
nrb<-iconv.data.frame(as.data.frame(as.character(myRB@data[,4])),from="UTF8",to="latin1")
...
leaflet(width = 800, height = 600) %>% 
    ...
    addLegend("bottomright", colors = c("#FF0000","#FFB233","#12D502","#FFFFFF","#FCEE07","#E2A904","#049BE2","#E204D8","#000000"), labels = c("SIDCO radio: 5 km","Puntos de calor","SNASPE","SN","BNP","SP","ICP","AAVC","RB")) %>%
    
    addLayersControl(baseGroups = c("Satélite", "Temático"),
      
    overlayGroups = c("SIDCO","Punto de calor VIIRS 48h","Punto de calor MODIS 48h","SNASPE","SN","BNP","SP","ICP","AAVC","RB"),
                   options = layersControlOptions(collapsed = FALSE))%>%
    hideGroup(c("Límite Regional","Punto de calor VIIRS 48h","Punto de calor MODIS 48h","SNASPE","SN","BNP","SP","ICP","AAVC","RB")) %>%
