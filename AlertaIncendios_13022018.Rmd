...
Focos de incendio: [Sistema de Información Digital para Control de Operación (SIDCO)](http://sidco.conaf.cl/login/index.php)  
Puntos de calor VIIRS y MODIS: [EARTHDATA NASA](https://earthdata.nasa.gov/earth-observation-data/near-real-time/firms/active-fire-data)  
Límites Sistema Nacional de Áreas Silvestres Protegidas del Estado (SNASPE): [Ministerio de Bienes Nacionales](http://www.ide.cl/descarga/capas/item/sistema-nacional-de-areas-silvestres-protegidas-del-estado-snaspe.html)  
Límites Santuario de la Naturaleza (SN): [Consejo de Monumentos Nacionales](http://www.ide.cl/descarga/capas/item/santuarios-de-la-naturaleza.html)  
Límites Bien Nacional Protegido (BNP): [Ministerio de Bienes Nacionales](http://www.ide.cl/descarga/capas/item/bienes-nacionales-protegidos.html)  
Límites Sitio Prioritario para la Conservación (SP): [Ministerio del Medio Ambiente](http://www.ide.cl/descarga/capas/item/sitios-prioritarios-de-conservacion-de-la-biodiversidad.html)  
Límites Iniciatica de Conservación Privada (ICP): [Ministerio del Medio Ambiente](http://bdrnap.mma.gob.cl/buscador-rnap/#/busqueda?p=14)  
Límites Áreas de Alto Valor para la Conservación (AAVC):[Ministerio del Medio Ambiente](http://bdrnap.mma.gob.cl/buscador-rnap/#/busqueda?p=14)  
Información de Biodiversidad: [Reglamento de Clasificación de Especies (RCE)](http://www.mma.gob.cl/clasificacionespecies/),
                              [Unión Internacional para la Conservación de la Naturaleza (UICN Red List)](http://www.iucnredlist.org/technical-documents/spatial-data)  

***
<center>
[![Alt text](github.jpg)](https://github.com/3khoz/FireAlert)
</center>
***
