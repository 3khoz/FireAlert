...
leaflet(width = 900, height = 800) %>% 
     ...
     addPolygons(data = mySP, fill = TRUE, stroke = TRUE, color = "#0F6600", highlightOptions = highlightOptions(color = "white", weight = 2),
    ...
    addLegend("bottomleft", colors = c("#FF0000","#FC6707","#12D502","#FFFFFF","#FCEE07","#0F6600","#049BE2","#E204D8","#000000","#0008FF"), labels = c("SIDCO radio: 5 km","Puntos de calor 48h","SNASPE","SN","BNP","SP","ICP","AAVC","RB","EMN")) %>%
