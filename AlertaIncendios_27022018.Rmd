...
coln<-c("Foco","RegiÃ³n","Provincia","Comuna","Estado actual","Nombre","Tipo de protecciÃ³n","Distancia al foco (km)")
...
bicho<-unique(bicho)
coln<-c("Sitio","Nombre","Anfibios","Reptiles","MamÃ¬feros")
...
leaflet(width = 900, height = 800) %>% 
    ...
    hideGroup(c("LÃ­mite Regional","Puntos de calor 48h","SNASPE","SN","BNP","SP","ICP","AAVC","RB","Ruil","Pitao","Keule","Alerce","Araucaria","Belloto del sur","Belloto del norte")) %>%
...
***
<center>
<a href="https://github.com/3khoz/FireAlert/blob/master"target="_blank"><img src="github.jpg"/</a>
</center>
***
